...
train_data = MyCustomOcrDataloader(TRAIN_PATH, preprocessor=processor, tokenizer  = tokenizer, img_root=IMG_ROOT)
...
max_seq_length              = 350 , # Max sequence length for transcripts. Check data verification.
).to(device)
